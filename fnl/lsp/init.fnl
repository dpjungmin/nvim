...
(tset vim.lsp.handlers :textDocument/signatureHelp
  (vim.lsp.with vim.lsp.handlers.signature_help {:focusable false :border :single}))
...
(fn on-attach [client bufnr]
  ...
  (map! [n] :<space>wl (fn [] (vim.notify (vim.inspect (vim.lsp.buf.list_workspace_folders)) vim.log.levels.INFO {:render :default :title "Workspace folders"})) {:desc "List workspace folders"}))
