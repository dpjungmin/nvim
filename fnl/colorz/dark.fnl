...
(hl! :BufferLineSeparatorVisible {:link :BufferLineSeparatorSelected})
...
(hl! :BufferLineNumbers {:link :BufferLineBackground})
(hl! :BufferLineNumbersSelected {:link :BufferLineBufferSelected})
(hl! :BufferLineNumbersVisible {:link :BufferLineNumbersSelected})
