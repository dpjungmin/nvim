...
(fn startup [use] ; It is recommened to put `impatient.nvim` before any other plugins
  (use [{1 :lewis6991/impatient.nvim :config "require('impatient')"}
        :wbthomason/packer.nvim
        :rktjmp/hotpot.nvim])
  (use [:nvim-lua/popup.nvim
        :nvim-lua/plenary.nvim
        :kyazdani42/nvim-web-devicons]) ; Use default configuration
  (use [:andymass/vim-matchup
        ...
        {1 :norcalli/nvim-colorizer.lua
         :event :VimEnter
         :config "require('colorizer').setup()"}]) ; Configuration set in `global.lua`
