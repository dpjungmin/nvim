(local auto-cmds {
  :hl-yank [["TextYankPost" "*" "silent!" "lua vim.highlight.on_yank { higroup = 'YankColor', timeout = 300, on_visual = true }"]]
  ...
  :au-reload [["FileChangedShellPost" "*" "vim.notify('File changed on disk. Buffer reloaded!', vim.log.levels.WARN)"]
