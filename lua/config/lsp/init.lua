...
local on_attach = function(client, bufnr)
  ...
  if client.resolved_capabilities.document_formatting then
    map('n', '<space>cf', vim.lsp.buf.formatting_sync, { desc = 'Formats the current buffer synchronously' })
  end
...
assert(capabilities.textDocument.completion.completionItem.snippetSupport, '[lspconfig] snippet support disabled')
